...
public class GirlGridViewBinder extends ItemViewProvider<Gank, GirlGridViewBinder.ViewHolder> {
    private Context mContext;

    public GirlGridViewBinder(Context context){
    ...
    @Override
    protected void onBindViewHolder(@NonNull ViewHolder holder, @NonNull final Gank gank) {
        holder.setData(gank);
    ...
    static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            ivGirl = (ImageView) itemView.findViewById(R.id.iv_girl_img);
            tvDate = (TextView) itemView.findViewById(R.id.tv_girl_date);
        }
